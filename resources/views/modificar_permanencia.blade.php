...
<head>
    ...
    <script type="text/javascript" src="../js/modificar_permanencia.js"></script>
    <title>Modificar permancia</title>
</head>
<body>
 ...
 <form action="../js/modificar_permanencia.js" method="get" name="permanencia">
    <fieldset id="fieldset">
        <legend>Modificar una permanencia</legend>
        ...
        <br><br>
        <input class="button" type="button" name="crear_modificar_permanencia" value="modificar una permanencia" onclick="modificar_permanencia()">
